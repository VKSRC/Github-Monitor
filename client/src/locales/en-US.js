export default {
  ...
  'github.list.storage-time': 'Storage Time',
  'github.list.solved': 'Solved',
  'github.list.add-whitelist': 'Add Whitelist',
  'github.list.ignore-repo': 'Ignore Repo',
  'github.list.ignore-repo.tooltip': 'Ignore all items found under the repository',
  ...
  'task.table.columns.start-time': 'Start time',
  ...
  'task.operation.delete-hint': 'Are you sure you want to delete the task?',
  'task.operation.no-operations': 'No operations are available',
  'task.operation.no-operations-hint': 'The running task could not be edited/deleted',
  ...
  'task.modal.field.ignore-username.hint':
    'Ignore the repo under the specified account and support multiple account names separated by line breaks, such as VKSRC',
